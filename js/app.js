...
class Game {
    constructor(player, adve) {
        ...
        this.current_index = 0; // lavaka ametrahana vato
        this.steps_nbr = 0; // isan'ny pas vita
                    ...
                    if (this.lanyV1() && this.nisyVatoTaoAmFarany()) {
                        if (this.afakaMaka()) {
                            if (this.adveTsisyVatoEoAmbony()) {
                                ...
                                yield time();
                                this.adve
                                    .getLavaka(Math.abs(this.current_index - 7))
                                    .setIsanVato(0);
                            }
                            else {
                                this.vato_noraisina =
